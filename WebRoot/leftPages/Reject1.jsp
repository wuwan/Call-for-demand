...
<script type="text/javascript" src="jiaoben1286-fenye/js/slimtable.min.js"></script>
	<form action="query3.action" method="post">
		<table align="center">
			<tr>
	...
	<thead>
		...
		<c:forEach var="list" items="${rejects }">
			<tr align="center"  height="24px">
				<td width="100">${list.crorder}</td>
				<td width="100">${list.re2}</td>
				<td width="120">
					<a href="causeSelect.action?param=0&crorder=${list.crorder}">查看理由</a>&nbsp;&nbsp;
				</td>
			</tr>
		</c:forEach>
	</table>
