...
<form action="shenpi.action"  method=post name="form1" onSubmit="return star()">
  <br>
...
（非基础研究填写）</td>
		...
		<tr>
								<td width="20"><input name="tbgovbelong.state" value="已通过" type="hidden" id="Role">
							</tr>
		<tr>
	  ...
	  <input type="submit" name="submit3" onclick="return confirm('确定退回吗')" value="退回">
				<input type="submit" name="submit4" onclick="return confirm('确定通过吗')" value="通过">
  </form>
  </center>
  </body>
</html>
