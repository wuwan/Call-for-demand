...
<body>
	<form action="tuihui.action" method="post">
	 <input type="hidden" name="param" value="1"/>
		<table class="STYLE2" align="center" style="margin-top:20px;margin-bottom:50px">
			...
			<tr>
								<td width="20"><input name="reject.re1" value="已退回" type="hidden" id="Role">
							</tr>
			<tr>
								<td width="20"><input name="reject.re2" value="待审核" type="hidden" id="Role">
							</tr>
			<tr>
